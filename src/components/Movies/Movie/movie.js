...
const Movie = props => {
  const cover = require(
      `../../../assets/img/episode_${ props.info.episode_id }.jpg`);
      ...
      <Grid>
        <Grid.Row>
          ...
          <Grid.Column computer={9} mobile={16} tablet={8}>
            <Header as='h2' textAlign='center' size='large'>{ props.info.title }</Header>
            <Header as='h3' textAlign='center' size='small'>Episode { props.info.episode_id }</Header>
            <Container className="textCrawl" fluid>{ props.info.opening_crawl }</Container>
          </Grid.Column>
